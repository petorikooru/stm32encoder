...
int main(void)
{
    ...
    printf("Encoder + Velocity Demo Started!\r\n");
...
{
	timer_counter = (int32_t)__HAL_TIM_GET_COUNTER(&htim3);
...
static void MX_TIM2_Init(void)
{
  ...
  HAL_TIM_Base_Start_IT(&htim3);   // Timer for velocity at 1ms
  HAL_TIM_Base_Start(&htim3);   // Timer for velocity at 1ms
